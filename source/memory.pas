...
{                                                       }
{       Anti203 modifications by Tony Berezin, 1994     }
{       Express Graphics Unit (EG/TV), 1994             }
{                                                       }
{*******************************************************}
...
begin
  if FreeCache then HeapNotify := 2 else
    if DisablePool then HeapNotify := 1 else
      if FreeSafetyPool then HeapNotify := 2 else
        HeapNotify := 1; {TONY}
end;
