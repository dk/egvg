...
{GLOBAL}
procedure read_color_map (cinfo : j_decompress_ptr; infile : FILEPtr);
...
{LOCAL}
procedure read_gif_map (cinfo : j_decompress_ptr;  infile : FILEPtr);
var
  header : packed array[0..13-1] of byte;
  i, colormaplen : int;
var
  color : RGBtype;
var
...
begin
  ...
  count := jread(infile, header, 13-1);
  if (count <> 13-1) then
