...
EXTERN(void) jinit_downsampler ((cinfo : j_compress_ptr));
EXTERN(void) jinit_forward_dct ((cinfo : j_compress_ptr));
EXTERN(void) jinit_huff_encoder ((cinfo : j_compress_ptr));
EXTERN(void) jinit_phuff_encoder ((cinfo : j_compress_ptr));
EXTERN(void) jinit_marker_writer ((cinfo : j_compress_ptr));
{ Decompression module initialization routines }
EXTERN(void) jinit_master_decompress ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_d_main_controller ((cinfo : j_decompress_ptr,
					  boolean need_full_buffer));
EXTERN(void) jinit_d_coef_controller ((cinfo : j_decompress_ptr,
					  boolean need_full_buffer));
EXTERN(void) jinit_d_post_controller ((cinfo : j_decompress_ptr,
					  boolean need_full_buffer));
EXTERN(void) jinit_input_controller ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_marker_reader ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_huff_decoder ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_phuff_decoder ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_inverse_dct ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_upsampler ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_color_deconverter ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_1pass_quantizer ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_2pass_quantizer ((cinfo : j_decompress_ptr));
EXTERN(void) jinit_merged_upsampler ((cinfo : j_decompress_ptr));
