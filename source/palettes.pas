{$G+,S-,F+}
{
  ...
  Û Unit        : VGA palettes handling                                Û
  Û Description : Virtual Graphics 256-color virtual palettes kernel   Û
  Û Author      : Dmitry Karasik                                       Û
  Û Version     : X01.00 (internal)                                    Û
  Û Release     : 01.00                                                Û
  Û Last update : 20-JAN-1996                                          Û
...
Const
  StdLogPalette : TLogPalette = (
    Mode     : 0;
    Colors   : 256;
    Palette  : @StdVGAPalette; {§¤¥áì 768 ¡ ©â áâ ­¤ àâ ¢£  ¯ «¨âà }
    ColorRef : @StdColorRefMap {§¤¥áì 256 ¡ ©â 0-255}
  );
...
Begin
  ...
  if PalBufferSize > SystemColors then begin
    ...
    if PalBuffer = nil then Exit; {â.¥. ¥á«¨ ­¥ ¡ã¤¥â ¯ ¬ïâ¨, â® ­¥ ¡ã¤¥â ®âà¨á®¢®ª!}
