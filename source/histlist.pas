...
procedure CleanHistoryUpCase(Id: Byte); {GIO}
...
begin
  ...
  { Delete duplicates }
  AdvanceStringPointer;
  while CurString <> nil do begin Str:=CurString^;
    if StUpCase(Str) = StUpCase(Str1) then DeleteString;
    AdvanceStringPointer;
    Str1:=Str;
  end;
end;
