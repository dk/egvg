...
(******************************************************************
 *                                                                *
 *       Œ“‹Ÿ–ˆŸ ’…Š‘’Ž‚ŽƒŽ Š“‘Ž€ ‚ ƒ€”ˆ—…‘ŠŽŒ …†ˆŒ…         *
 *                                                                *
 *  ˆ¬ï ä ©« :                 EGCursor.PAS                       *
 *  €¢â®à:                     Tony Berezin                       *
 *  „ â  ­ ç «  à §à ¡®âª¨:    05-JAN-1994                        *
 *  „ â  ®ª®­ç ­¨ï à §à ¡®âª¨: 05-JAN-1994                        *
 *                                                                *
 ******************************************************************)

interface uses Objects,  GDI;  { Ð¡Ñ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ð½Ñ‹Ðµ Ð¾Ð±ÑŠÐµÐºÑ‚Ñ‹ Borland Pascal }
...
type
  TTextCursor = object(TObject)
   public
    ...
    procedure SetHeight(h: byte);  { Ð´Ð»Ñ Ð¿ÐµÑ€ÐµÐ½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ ÐºÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚ }
...
procedure TTextCursor.SetHeight(h: byte);  { Ð´Ð»Ñ Ð¿ÐµÑ€ÐµÐ½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ ÐºÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚ }
begin
