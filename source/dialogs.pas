...
{ CLabel         ║ 1 │ 2 │ 3 │ 4 │ 5 │ 6 ║                  }
{                ╚═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╝                  }
{ Text Normal fore ┘   │   │   │   │   └─ Shortcut Selected }
{             back ────┘   │   │   └─────── Shortcut Normal }
{ Text Selected fore ──────┘   │                            }
{               back ──────────┘                            }
...
{              ╔═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╗ }
{ CButton      ║ 1 │ 2 │ 3 │ 4 │ 5 │ 6 │ 7 │ 8 │ 9 │ A │ B │ C │ D ║ }
{              ╚═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╝ }
{ Normal fore ───┘   │   │   │   │   │   │   │   │   │   │   │   │   }
{        back ───────┘   │   │   │   │   │   │   │   │   │   │   │   }
{ Default fore ──────────┘   │   │   │   │   │   │   │   │   │   │   }
...
{                    ╔═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╗ }
{ CHistoryWindow     ║ 1 │ 2 │ 3 │ 4 │ 5 │ 6 │ 7 │ 8 │ 9 ║ }
{                    ╚═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╧═╤═╝ }
{ Passive Frame back ──┘   │   │   │   │   │   │   │   │   }
{ Active  Frame back ──────┘   │   │   │   │   │   │   │   }
{ Passive Title fore ──────────┘   │   │   │   │   │   │   }
...
const shpUser: Word = fsInterleave; {здеся для альтерн Fill в Shade}
...
{ процедуры быстрого создания стандартных кнопок }
...
begin
  ...
  Dec(R.B.X, 19); { На ширину Frame'а плюс ширину скроллбара }
