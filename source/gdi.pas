...
Begin
  ...
  if (Options and cbwInit) <> 0 then begin
    ...
    T.Palette := Palette;
    {ÆÁ•≠Ï Æ·‚Æ‡Æ¶≠Æ - •·´® ≠• „·‚†≠Æ¢´•≠ cbwInit ® Ø‡Æ¢Æ§®‚·Ô
    ÆØ•‡†Ê®Ô ≠†§ Ø†´®‚‡Æ©, ‚Æ ®ß¨•≠Ô•‚·Ô _Æ‡®£®≠†´Ï≠†Ô_ Ø†´®‚‡†}
   end;
...
{·´•§„ÓÈ®• §¢• Ø‡ÆÊ•§„‡Î ß†§•‡‚Î ®ß ™®•¢·™Æ£Æ Vision'a
(‚• ¢ ·¢ÆÓ ÆÁ•‡•§Ï ®ß ê.ì®´‚Æ≠†). è•‡•§•´™® _°Î´®_.}
procedure FillEllipse(X, Y, Rx, Ry : Integer; var T : TPaintInfo);
var
  Xc, Yc : Integer;
...
{ù‚† ß†‡†ß† ß†§•‡‚† ®ß ¨Æ·™Æ¢·™Æ£Æ SuperVision'a}
procedure FillPoly(NumPoints: Word;var Polygon; At : TPoint;var T : TPaintInfo);{ÇÆ´Æ§®≠ Ç.Ä.}
type
